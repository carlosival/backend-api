...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'myjwt_token_authenticator' => 'getMyjwtTokenAuthenticatorService',
            ...
            'vich_uploader.namer_uniqid.receta_image' => 'getVichUploader_NamerUniqid_RecetaImageService',
            'vich_uploader.namer_uniqid.usuario_avatar' => 'getVichUploader_NamerUniqid_UsuarioAvatarService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('ezs9no3xhS', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TzdF-b5t+g', 0, 'PxU9l2X1T6Y4Yod-EbvTU+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('usuario_avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('receta_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('usuario_avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('usuario_avatar', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('receta_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('receta_image', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'dieta', 'user' => 'root', 'password' => 'carlos', 'charset' => 'utf8mb4', 'driverOptions' => array(), 'defaultTableOptions' => array('charset' => 'utf8mb4', 'collate' => 'utf8mb4_unicode_ci')), $d, $f, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = DoctrineORMEntityManager_000000002e73263e0000000073f22027f0bf497c830307a6c1fd3273ac51e792::staticProxyConstructor(
        ...
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/config/doctrine') => 'FOS\\CommentBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'FOS\\CommentBundle\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/DietaBundle/Entity'))), 'DietaBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('FOSCommentBundle' => 'FOS\\CommentBundle\\Entity', 'DietaBundle' => 'DietaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_119bec7407c1e4fa9a188a91a4b1266754486c94c3a6dc322687aefe824a8132');
    ...
    {
        return $this->services['fos_comment.form_type.comment.default'] = new \FOS\CommentBundle\Form\CommentType('DietaBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.commentable_thread.default'] = new \FOS\CommentBundle\Form\CommentableThreadType('DietaBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.form_type.delete_comment.default'] = new \FOS\CommentBundle\Form\DeleteCommentType('DietaBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.thread.default'] = new \FOS\CommentBundle\Form\ThreadType('DietaBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.sorting_factory'), ${($_ = isset($this->services['fos_comment.entity_manager']) ? $this->services['fos_comment.entity_manager'] : $this->getFosComment_EntityManagerService()) && false ?: '_'}, 'DietaBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('debug.event_dispatcher'), ${($_ = isset($this->services['fos_comment.entity_manager']) ? $this->services['fos_comment.entity_manager'] : $this->getFosComment_EntityManagerService()) && false ?: '_'}, 'DietaBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.manager.vote.default'] = new \FOS\CommentBundle\Entity\VoteManager($this->get('debug.event_dispatcher'), ${($_ = isset($this->services['fos_comment.entity_manager']) ? $this->services['fos_comment.entity_manager'] : $this->getFosComment_EntityManagerService()) && false ?: '_'}, 'FOS\\CommentBundle\\Entity\\Vote');
    }
    ...
    public function getFosRest_SerializerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_rest.serializer'] = FOSRestBundleSerializerJMSSerializerAdapter_000000002e73235d0000000073f22027f0bf497c830307a6c1fd3273ac51e792::staticProxyConstructor(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('DietaBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('carlosmartinezival@gmail.com' => 'carlosmartinezival@gmail.com'), 'resetting' => array('carlosmartinezival@gmail.com' => 'carlosmartinezival@gmail.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('DietaBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('DietaBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('DietaBundle\\Entity\\User');
    }
    ...
    public function getFosUser_UserManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_user.user_manager'] = FOSUserBundleDoctrineUserManager_000000002e7322670000000073f22027f0bf497c830307a6c1fd3273ac51e792::staticProxyConstructor(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader(($this->targetDirs[3].'/app/../var/jwt/private.pem'), ($this->targetDirs[3].'/app/../var/jwt/public.pem'), 'yanelis*89');
    }
    ...
    /**
     * Gets the 'myjwt_token_authenticator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DietaBundle\Security\JwtTokenAuthenticator A DietaBundle\Security\JwtTokenAuthenticator instance
     */
    protected function getMyjwtTokenAuthenticatorService()
    {
        return $this->services['myjwt_token_authenticator'] = new \DietaBundle\Security\JwtTokenAuthenticator($this->get('lexik_jwt_authentication.encoder.default'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.et.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.bg.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml'), 4 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.uk.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.it.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.it.yml')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ar.yml')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.de.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.de.yml')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.fr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.fr.yml')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.nl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pl.yml')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.en.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.en.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.ru.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.tr.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml'), 5 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.pt.yml')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.hu.yml')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.sl.yml')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.es.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.es.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.sr_Cyrl.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.cs.yml')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.ja.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.af.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.mn.yml')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.zh_CN.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')), 'fa_IR' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/translations/FOSCommentBundle.fa_IR.yml')), 'ky' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ky.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ky.yml')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'autoescape' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension(${($_ = isset($this->services['assetic.asset_factory']) ? $this->services['assetic.asset_factory'] : $this->getAssetic_AssetFactoryService()) && false ?: '_'}, $this->get('templating.name_parser'), true, array(), array(0 => 'FOSCommentBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/views'), 'FOSComment');
        $instance->addPath(($this->targetDirs[3].'/src/DietaBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/views'), 'VichUploader');
        $instance->addPath(($this->targetDirs[3].'/src/DietaBundle/Resources/views'), 'Dieta');
        $instance->addPath(($this->targetDirs[3].'/src/FrontDietaBundle/Resources/views'), 'FrontDieta');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e4bb64ece154c23f2c432d5ffc623d115b6a08ce');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/config/validation.xml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml')));
    ...
    /**
     * Gets the 'vich_uploader.namer_uniqid.receta_image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer A Vich\UploaderBundle\Naming\UniqidNamer instance
     */
    protected function getVichUploader_NamerUniqid_RecetaImageService()
    {
        return $this->services['vich_uploader.namer_uniqid.receta_image'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }

    /**
     * Gets the 'vich_uploader.namer_uniqid.usuario_avatar' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer A Vich\UploaderBundle\Naming\UniqidNamer instance
     */
    protected function getVichUploader_NamerUniqid_UsuarioAvatarService()
    {
        return $this->services['vich_uploader.namer_uniqid.usuario_avatar'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OOKPMQSFaK', 0, 'PxU9l2X1T6Y4Yod-EbvTU+', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['jms_serializer.metadata.file_locator'] = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\CommentBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/app/serializer/FOSUB'), 'Bazinga\\Bundle\\HateoasBundle' => ($this->targetDirs[3].'/vendor/willdurand/hateoas-bundle/Bazinga/Bundle/HateoasBundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Vich\\UploaderBundle' => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Resources/config/serializer'), 'DietaBundle' => ($this->targetDirs[3].'/src/DietaBundle/Resources/config/serializer'), 'FrontDietaBundle' => ($this->targetDirs[3].'/src/FrontDietaBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Resources/config/serializer'), '' => ($this->targetDirs[3].'/src/DietaBundle/Resources/config/serializer')));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'login', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58e917dedf2307.57882662'), 2 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('lexik_jwt_authentication.jwt_token_authenticator')), $a, 'main', $b)), true);
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.frontend' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api')));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, ${($_ = isset($this->services['vich_uploader.metadata_reader']) ? $this->services['vich_uploader.metadata_reader'] : $this->getVichUploader_MetadataReaderService()) && false ?: '_'}, array('receta_image' => array('uri_prefix' => '/images/recetas', 'upload_destination' => ($this->targetDirs[3].'/app/../web/images/recetas'), 'namer' => array('service' => 'vich_uploader.namer_uniqid.receta_image', 'options' => array()), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'directory_namer' => array('service' => NULL, 'options' => NULL), 'db_driver' => 'orm'), 'usuario_avatar' => array('uri_prefix' => '/images/usuarios', 'upload_destination' => ($this->targetDirs[3].'/app/../web/images/usuarios'), 'namer' => array('service' => 'vich_uploader.namer_uniqid.usuario_avatar', 'options' => array()), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'directory_namer' => array('service' => NULL, 'options' => NULL), 'db_driver' => 'orm')), '_name');
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'FOSCommentBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/friendsofsymfony/comment-bundle'),
                ...
                'DietaBundle' => array(
                    ...
                    'path' => ($this->targetDirs[3].'/src/DietaBundle'),
                    'namespace' => 'DietaBundle',
                ),
                'FrontDietaBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/FrontDietaBundle'),
            ...
            case 'vich_uploader.mappings': $value = array(
                'receta_image' => array(
                    'uri_prefix' => '/images/recetas',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/images/recetas'),
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.receta_image',
                        'options' => array(
                ...
                'usuario_avatar' => array(
                    'uri_prefix' => '/images/usuarios',
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/images/usuarios'),
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.usuario_avatar',
                        'options' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DietaBundle' => 'DietaBundle\\DietaBundle',
                'FrontDietaBundle' => 'FrontDietaBundle\\FrontDietaBundle',
            ...
            'database_name' => 'dieta',
            'database_user' => 'root',
            'database_password' => 'carlos',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'e4bb64ece154c23f2c432d5ffc623d115b6a08ce',
            'jwt_key_pass_phrase' => 'yanelis*89',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e4bb64ece154c23f2c432d5ffc623d115b6a08ce',
            ...
            'fos_comment.model.thread.class' => 'DietaBundle\\Entity\\Thread',
            'fos_comment.model.comment.class' => 'DietaBundle\\Entity\\Comment',
            ...
            'fos_user.model.user.class' => 'DietaBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'carlosmartinezival@gmail.com' => 'carlosmartinezival@gmail.com',
            ),
            ...
            'lexik_jwt_authentication.pass_phrase' => 'yanelis*89',
...
class DoctrineORMEntityManager_000000002e73263e0000000073f22027f0bf497c830307a6c1fd3273ac51e792 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58e917e32c9b2574310086 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58e917e32c9f7259092619 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58e917e32c8bf340177364 = array(
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getConnection', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getConnection();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getMetadataFactory', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getMetadataFactory();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getExpressionBuilder', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getExpressionBuilder();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'beginTransaction', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->beginTransaction();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getCache', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getCache();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'transactional', array('func' => $func), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->transactional($func);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'commit', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->commit();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'rollback', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->rollback();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getClassMetadata', array('className' => $className), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getClassMetadata($className);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'createQuery', array('dql' => $dql), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->createQuery($dql);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'createNamedQuery', array('name' => $name), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->createNamedQuery($name);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'createQueryBuilder', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->createQueryBuilder();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'flush', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->flush($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'clear', array('entityName' => $entityName), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->clear($entityName);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'close', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->close();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'persist', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->persist($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'remove', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->remove($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'refresh', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->refresh($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'detach', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->detach($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'merge', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->merge($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->copy($entity, $deep);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getRepository($entityName);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'contains', array('entity' => $entity), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->contains($entity);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getEventManager', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getEventManager();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getConfiguration', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getConfiguration();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'isOpen', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->isOpen();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getUnitOfWork', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getUnitOfWork();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getProxyFactory', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getProxyFactory();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'initializeObject', array('obj' => $obj), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->initializeObject($obj);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'getFilters', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->getFilters();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'isFiltersStateClean', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->isFiltersStateClean();
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'hasFilters', array(), $this->initializer58e917e32c9f7259092619);

        return $this->valueHolder58e917e32c9b2574310086->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer58e917e32c9f7259092619 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder58e917e32c9b2574310086) {
            $reflection = $reflection ?: new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder58e917e32c9b2574310086 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder58e917e32c9b2574310086->__construct($conn, $config, $eventManager);
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, '__get', ['name' => $name], $this->initializer58e917e32c9f7259092619);

        if (isset(self::$publicProperties58e917e32c8bf340177364[$name])) {
            return $this->valueHolder58e917e32c9b2574310086->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e917e32c9b2574310086;
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58e917e32c9f7259092619);
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, '__isset', array('name' => $name), $this->initializer58e917e32c9f7259092619);
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, '__unset', array('name' => $name), $this->initializer58e917e32c9f7259092619);
    ...
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, '__clone', array(), $this->initializer58e917e32c9f7259092619);

        $this->valueHolder58e917e32c9b2574310086 = clone $this->valueHolder58e917e32c9b2574310086;
    }

    public function __sleep()
    {
        $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, '__sleep', array(), $this->initializer58e917e32c9f7259092619);

        return array('valueHolder58e917e32c9b2574310086');
    }
    ...
    {
        $this->initializer58e917e32c9f7259092619 = $initializer;
    }
    ...
    {
        return $this->initializer58e917e32c9f7259092619;
    }
    ...
    {
        return $this->initializer58e917e32c9f7259092619 && $this->initializer58e917e32c9f7259092619->__invoke($this->valueHolder58e917e32c9b2574310086, $this, 'initializeProxy', array(), $this->initializer58e917e32c9f7259092619);
    }
    ...
    {
        return null !== $this->valueHolder58e917e32c9b2574310086;
    }
    ...
    {
        return $this->valueHolder58e917e32c9b2574310086;
    }


}

class FOSUserBundleDoctrineUserManager_000000002e7322670000000073f22027f0bf497c830307a6c1fd3273ac51e792 extends \FOS\UserBundle\Doctrine\UserManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58e917e352adb866957339 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58e917e352b1e804400326 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58e917e352a11529800616 = array(
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'deleteUser', array('user' => $user), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->deleteUser($user);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'getClass', array(), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->getClass();
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'findUserBy', array('criteria' => $criteria), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->findUserBy($criteria);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'findUsers', array(), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->findUsers();
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'reloadUser', array('user' => $user), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->reloadUser($user);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'updateUser', array('user' => $user, 'andFlush' => $andFlush), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->updateUser($user, $andFlush);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'createUser', array(), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->createUser();
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'findUserByEmail', array('email' => $email), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->findUserByEmail($email);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'findUserByUsername', array('username' => $username), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->findUserByUsername($username);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'findUserByUsernameOrEmail', array('usernameOrEmail' => $usernameOrEmail), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->findUserByUsernameOrEmail($usernameOrEmail);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'findUserByConfirmationToken', array('token' => $token), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->findUserByConfirmationToken($token);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'updateCanonicalFields', array('user' => $user), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->updateCanonicalFields($user);
    }
    ...
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'updatePassword', array('user' => $user), $this->initializer58e917e352b1e804400326);

        return $this->valueHolder58e917e352adb866957339->updatePassword($user);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer58e917e352b1e804400326 = $initializer;
    ...
    public function __construct(\FOS\UserBundle\Util\PasswordUpdaterInterface $passwordUpdater, \FOS\UserBundle\Util\CanonicalFieldsUpdater $canonicalFieldsUpdater, \Doctrine\Common\Persistence\ObjectManager $om, $class)
    {
        ...
        if (! $this->valueHolder58e917e352adb866957339) {
            $reflection = $reflection ?: new \ReflectionClass('FOS\\UserBundle\\Doctrine\\UserManager');
            $this->valueHolder58e917e352adb866957339 = $reflection->newInstanceWithoutConstructor();
        ...
        $this->valueHolder58e917e352adb866957339->__construct($passwordUpdater, $canonicalFieldsUpdater, $om, $class);
    }
    ...
    public function & __get($name)
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, '__get', ['name' => $name], $this->initializer58e917e352b1e804400326);

        if (isset(self::$publicProperties58e917e352a11529800616[$name])) {
            return $this->valueHolder58e917e352adb866957339->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e917e352adb866957339;
    ...
    public function __set($name, $value)
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58e917e352b1e804400326);
    ...
    public function __isset($name)
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, '__isset', array('name' => $name), $this->initializer58e917e352b1e804400326);
    ...
    public function __unset($name)
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, '__unset', array('name' => $name), $this->initializer58e917e352b1e804400326);
    ...
    public function __clone()
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, '__clone', array(), $this->initializer58e917e352b1e804400326);

        $this->valueHolder58e917e352adb866957339 = clone $this->valueHolder58e917e352adb866957339;
    }

    public function __sleep()
    {
        $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, '__sleep', array(), $this->initializer58e917e352b1e804400326);

        return array('valueHolder58e917e352adb866957339');
    }
    ...
    public function setProxyInitializer(\Closure $initializer = null)
    {
        $this->initializer58e917e352b1e804400326 = $initializer;
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer58e917e352b1e804400326;
    }
    ...
    public function initializeProxy() : bool
    {
        return $this->initializer58e917e352b1e804400326 && $this->initializer58e917e352b1e804400326->__invoke($this->valueHolder58e917e352adb866957339, $this, 'initializeProxy', array(), $this->initializer58e917e352b1e804400326);
    }
    ...
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder58e917e352adb866957339;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58e917e352adb866957339;
    }


}

class FOSRestBundleSerializerJMSSerializerAdapter_000000002e73235d0000000073f22027f0bf497c830307a6c1fd3273ac51e792 extends \FOS\RestBundle\Serializer\JMSSerializerAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58e917e35c3b0371821861 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58e917e35c3f4656882225 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58e917e35c2e0518827466 = array(
    ...
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, 'serialize', array('data' => $data, 'format' => $format, 'context' => $context), $this->initializer58e917e35c3f4656882225);

        return $this->valueHolder58e917e35c3b0371821861->serialize($data, $format, $context);
    }
    ...
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, 'deserialize', array('data' => $data, 'type' => $type, 'format' => $format, 'context' => $context), $this->initializer58e917e35c3f4656882225);

        return $this->valueHolder58e917e35c3b0371821861->deserialize($data, $type, $format, $context);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer58e917e35c3f4656882225 = $initializer;
    ...
    public function __construct(\JMS\Serializer\SerializerInterface $serializer)
    {
        ...
        if (! $this->valueHolder58e917e35c3b0371821861) {
            $reflection = $reflection ?: new \ReflectionClass('FOS\\RestBundle\\Serializer\\JMSSerializerAdapter');
            $this->valueHolder58e917e35c3b0371821861 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\FOS\RestBundle\Serializer\JMSSerializerAdapter $instance) {
            unset($instance->serializer);
        ...
        $this->valueHolder58e917e35c3b0371821861->__construct($serializer);
    }
    ...
    public function & __get($name)
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, '__get', ['name' => $name], $this->initializer58e917e35c3f4656882225);

        if (isset(self::$publicProperties58e917e35c2e0518827466[$name])) {
            return $this->valueHolder58e917e35c3b0371821861->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58e917e35c3b0371821861;
    ...
    public function __set($name, $value)
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58e917e35c3f4656882225);
    ...
    public function __isset($name)
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, '__isset', array('name' => $name), $this->initializer58e917e35c3f4656882225);
    ...
    public function __unset($name)
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, '__unset', array('name' => $name), $this->initializer58e917e35c3f4656882225);
    ...
    public function __clone()
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, '__clone', array(), $this->initializer58e917e35c3f4656882225);

        $this->valueHolder58e917e35c3b0371821861 = clone $this->valueHolder58e917e35c3b0371821861;
    }

    public function __sleep()
    {
        $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, '__sleep', array(), $this->initializer58e917e35c3f4656882225);

        return array('valueHolder58e917e35c3b0371821861');
    }
    ...
    public function setProxyInitializer(\Closure $initializer = null)
    {
        $this->initializer58e917e35c3f4656882225 = $initializer;
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer58e917e35c3f4656882225;
    }
    ...
    public function initializeProxy() : bool
    {
        return $this->initializer58e917e35c3f4656882225 && $this->initializer58e917e35c3f4656882225->__invoke($this->valueHolder58e917e35c3b0371821861, $this, 'initializeProxy', array(), $this->initializer58e917e35c3f4656882225);
    }
    ...
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder58e917e35c3b0371821861;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58e917e35c3b0371821861;
    }
